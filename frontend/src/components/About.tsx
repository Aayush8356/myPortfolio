      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 mb-8 md:mb-12">
            <Card className="bg-dark-card backdrop-blur-sm border-2 border-gray-500 hover:border-accent/80 transition-all duration-300 shadow-xl hover:shadow-2xl rounded-lg">
          ...
          <Card className="mb-8 md:mb-10 bg-dark-card backdrop-blur-sm border-2 border-gray-500 hover:border-accent/80 transition-all duration-300 shadow-xl hover:shadow-2xl rounded-lg">
            <CardHeader className="pb-4">
              <CardTitle className="text-foreground uppercase-spaced text-base md:text-lg lg:text-xl font-semibold">
                SKILLS & TECHNOLOGIES
              </CardTitle>
