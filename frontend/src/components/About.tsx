      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 mb-8 md:mb-12">
            <Card className="bg-dark-card backdrop-blur-sm hover:border-cyan-300 transition-all duration-300 shadow-xl hover:shadow-2xl rounded-lg" style={{border: '2px solid #06b6d4'}}>
