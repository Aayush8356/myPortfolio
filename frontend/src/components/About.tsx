    ...
    <section id="about" className="py-12 md:py-20 bg-background relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8 md:mb-10 bg-dark-card backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 shadow-xl hover:shadow-2xl rounded-lg" style={{border: '1px solid rgba(59, 130, 246, 0.3)', boxShadow: '0 0 15px rgba(59, 130, 246, 0.1)'}}>
            <CardHeader className="pb-4">
              <CardTitle className="text-foreground uppercase-spaced text-base md:text-lg lg:text-xl font-semibold">
                SKILLS & TECHNOLOGIES
              </CardTitle>
